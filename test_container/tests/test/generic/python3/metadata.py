...
class MetaDataTest(udf.TestCase):
    ...
    def test_input_columns(self):
        ...
        self.assertTrue(r0[2].upper() == 'NUMBER' or r0[2].upper() == "<TYPE 'FLOAT'>" or r0[2].upper() == "DOUBLE" or r0[2].upper() == "<CLASS 'FLOAT'>")
        self.assertTrue(r0[3].upper() == 'DOUBLE')
        self.assertTrue(r1[0] == 2)
        self.assertTrue(r1[1].upper() == 'C2')
        self.assertTrue(r1[2].upper() == 'STRING' or r1[2].upper() == "<TYPE 'UNICODE'>" or r1[2].upper() == "CHARACTER" or r1[2].upper() == "<CLASS 'STR'>")
    ...
    def test_output_columns(self):
        ...
        self.assertTrue(r0[2].upper() == 'NUMBER' or r0[2].upper() == "<TYPE 'FLOAT'>" or r0[2].upper() == "DOUBLE" or r0[2].upper() == "<CLASS 'FLOAT'>")
        self.assertTrue(r1[2].upper() == 'STRING' or r1[2].upper() == "<TYPE 'UNICODE'>" or r1[2].upper() == "CHARACTER" or r1[2].upper() == "<CLASS 'STR'>")
        self.assertTrue(r2[2].upper() == 'STRING' or r2[2].upper() == "<TYPE 'UNICODE'>" or r2[2].upper() == "CHARACTER" or r2[2].upper() == "<CLASS 'STR'>")
        self.assertTrue(r3[2].upper() == 'STRING' or r3[2].upper() == "<TYPE 'UNICODE'>" or r3[2].upper() == "CHARACTER" or r3[2].upper() == "<CLASS 'STR'>")
        self.assertTrue(r4[2].upper() == 'NUMBER' or r4[2].upper() == "<TYPE 'FLOAT'>" or r4[2].upper() == "DOUBLE" or r4[2].upper() == "<CLASS 'FLOAT'>")
        self.assertTrue(r5[2].upper() == 'NUMBER' or r5[2].upper() == "<TYPE 'FLOAT'>" or r5[2].upper() == "DOUBLE" or r5[2].upper() == "<CLASS 'FLOAT'>")
        self.assertTrue(r6[2].upper() == 'NUMBER' or r6[2].upper() == "<TYPE 'FLOAT'>" or r6[2].upper() == "DOUBLE" or r6[2].upper() == "<CLASS 'FLOAT'>")
        self.assertTrue(r0[3].upper() == 'DOUBLE')
        self.assertTrue(r1[3].upper().startswith('VARCHAR(200)'))
